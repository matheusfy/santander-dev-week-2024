...
>
> A API está hospedada em um ambiente da AWS utilizando o **Elastic Beanstalk**. Para acessar o swagger da aplicação utilize o link: [Swagger_API](http://sdw2024-yoko.sa-east-1.elasticbeanstalk.com/swagger-ui/index.html) caso queira realizar testes.
